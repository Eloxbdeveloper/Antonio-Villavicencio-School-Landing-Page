...
El proyecto fue diseñado bajo un enfoque mobile-first y completamente adaptable. Se utilizaron media queries estratégicamente estructuradas para garantizar que la distribución de columnas, tarjetas y elementos interactivos se reorganice correctamente según el tamaño de pantalla.
